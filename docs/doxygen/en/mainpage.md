...
As of March 2026, the project includes:
- A functional lobby with player movement, physics, and UI elements like skin selection.
- One integrated mini-game: **Solitaire (Klondike)** - a classic card game with drag-and-drop.
...
- More games: Snake, Block-Blast, Tetris, etc.
...
### Solitaire Module
A classic Klondike Solitaire card game.

- **Gameplay**: Drag and drop cards between piles, build foundations by suit (Ace to King)
- **Features**: Multiple card selection, score tracking, timer, win/lose detection
- **Controls**: Left click to drag, N for new game
- **Integration**: Opaque SolitaireGameState, init/update/draw/free functions

Core files: solitaireAPI.h/c (API), core/game.h (logic), ui/renderer.h (render).

See: @ref solitaire "Solitaire Module Overview"
