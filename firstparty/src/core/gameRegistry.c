...
static const GameServerInterface_St* gameInterfaces[__miniGameIdCount] = {
    [MINI_GAME_ID_BINGO]            = &bingo_serverInterface,
    [MINI_GAME_ID_BOWLING]          = NULL,
    [MINI_GAME_ID_CHESS]            = &chess_serverInterface,
    [MINI_GAME_ID_DISC_REVERSAL]    = NULL, // TODO
    [MINI_GAME_ID_DROP_FOUR]        = NULL, // TODO
    [MINI_GAME_ID_EDITOR]           = NULL,
    [MINI_GAME_ID_KING_FOR_FOUR]    = &kingForFour_serverInterface,
    [MINI_GAME_ID_LOBBY]            = &lobby_serverInterface,
    ...
    [MINI_GAME_ID_TWIST_CUBE]       = &twistCube_serverInterface,
};
