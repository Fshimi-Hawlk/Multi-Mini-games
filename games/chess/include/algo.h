...
/**
    ...
    @param[in,out] board              The game board
    @param[in,out] selectionnedPiece  The piece to move
    @param[in]     boardPos           The target position
...
/**
    ...
    @param[in] selectionnedPiece  The piece to check
...
/**
    ...
    @param[in] board              The game board
    @param[in] selectionnedPiece  The piece to move
    @param[in] col                The target column
    @param[in] lig                The target row
    @param[in] joueur             The player whose turn it is (0 for white, 1 for black)
...
/**
    ...
    @param[in] board    The game board
    @param[in] playerM  The player to check (0 for white, 1 for black)
    @param[in] xCase    The x coordinate of the square
    @param[in] yCase    The y coordinate of the square
...
/**
    ...
    @param[in,out] board  The game board
    @return               true if a choice was made, false otherwise
*/
...
/**
    ...
    @param[in,out] board            The game board
    @param[in]     coupPredefinis   Array of move strings in algebraic notation
    @param[in]     nCoup            Number of moves to apply
*/
