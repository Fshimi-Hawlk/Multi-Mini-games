...
extern Rectangle bb_windowRect;            ///< Main window rectangle (set at init).
extern Font      bb_appFont;               ///< Primary font for UI text.
extern Font      bb_fonts[_fontSizeCount]; ///< Array of loaded fonts in increasing sizes.
