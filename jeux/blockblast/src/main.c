...
/* CONTEXT_ARENA_IMPLEMENTATION and RAND_IMPLEMENTATION are defined in
 * blockBlastAPI.c which is always compiled alongside main.c (LIB_SOURCES).
 * Defining them here too would create duplicate symbols at link time. */
