...
GameAssets kingforfour_LoadAssets(void) {
    GameAssets assets;
    
    // Chargement de la planche de sprites (Faces)
    assets.cardSheet = LoadTexture("jeux/kingforfour/assets/king_for_four/playingCards.png");

    // Chargement du dos (Back)
    assets.cardBack = LoadTexture("jeux/kingforfour/assets/king_for_four/cardBack_blue5.png");
...
void kingforfour_UnloadAssets(GameAssets assets) {
