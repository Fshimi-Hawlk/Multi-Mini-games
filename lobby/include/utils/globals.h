...
// ────────────────────────────────────────────────
// Game zones for mini-game triggers
// ────────────────────────────────────────────────

/**
    brief Static array of game zone definitions for the lobby scene.
          Each zone triggers a different mini-game when player enters.
 */
extern GameZone_st gameZones[];

/**
    brief Number of valid entries in the gameZones array.
 */
extern u32 gameZoneCount;
